	                    ...
	                    <div class="panel panel-primary">
	                        ...
	                        <div class="panel-body">
								...
								<f:form modelAttribute="client" action="${urlEnregistrer }" enctype="multipart/form-data" role = "form">
                                    ...
                                    <div class="form-group">
                                        <label><fmt:message code="common.cin" /></label>
                                        <f:input path="cin" class="form-control" placeholder="CIN" />
                                    </div>
                                    <div class="form-group">
                                        <label><fmt:message code="common.tel" /></label>
                                        <f:input path="tel" class="form-control" placeholder="TEL" />
                                    </div>
                                    <div class="form-group">
                                        <label><fmt:message code="common.etat" /></label>
                                        <f:input path="etat" class="form-control" placeholder="Etat" />
                                    </div>
